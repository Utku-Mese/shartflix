...
class _AuthApiService implements AuthApiService {
  ...
  Future<ApiResponse<UploadPhotoResponse>> uploadProfilePhoto(
    ...
    final _options = _setStreamType<ApiResponse<UploadPhotoResponse>>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late ApiResponse<UploadPhotoResponse> _value;
    try {
      _value = ApiResponse<UploadPhotoResponse>.fromJson(
        _result.data!,
