class ApiConstants {
  ...
  static String removeFromFavorites(int movieId) => '/movies/$movieId/unfavorite';
  static String addToWatchLater(int movieId) => '/movies/$movieId/watch-later';
  static String removeFromWatchLater(int movieId) => '/movies/$movieId/remove-watch-later';
